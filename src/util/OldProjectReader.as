...
public class OldProjectReader {
	...
	private function fixWatchers(newStage:*):void { //uuu Scratch Stage
	...
	private function buildLists(pairs:Array, targetObj:*):Array { //uuu ScratchObj
		if (pairs == null) return [];
		var result:Array = [];
		for (var i:int = 0; i < (pairs.length - 1); i += 2) {
