...
public class Primitives {
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		// android
		primTable["canVibrate"]			= function(b:*):* { return Vibration.isSupported };
		primTable["vibrate"]			= function(b:*):* { var v:Vibration=new Vibration(); v.vibrate(interp.numarg(b, 0)) }
		primTable["canGyro"]			= function(b:*):* { return Accelerometer.isSupported };
		primTable["gyroX"]				= function(b:*):* { return app.runtime.gyro.gyroX } //For some reason, the value is set back to 0 while not being updated...
		primTable["gyroY"]				= function(b:*):* { return app.runtime.gyro.gyroY }
		primTable["gyroZ"]				= function(b:*):* { return app.runtime.gyro.gyroZ }
		primTable["showMessage"]		= function(b:*):* { AirAlert.getInstance().showAlert(interp.arg(b, 0), interp.arg(b, 1)); }
		primTable["sendSMS"]			= function(b:*):* { AndroidExtensions.sendSMS(interp.arg(b, 0), interp.arg(b, 1)); }
		primTable["hasGps"]				= function(b:*):* { return Geolocation.isSupported; }
		//primTable["geoLat"]				= function(b:*):* { return lat; }
		//primTable["geoLon"]				= function(b:*):* { return lon; }
		//primTable["speed"]				= function(b:*):* { return speed; }
