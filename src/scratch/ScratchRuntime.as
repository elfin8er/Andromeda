...
//----------
	...
	protected function installProject(project:ScratchStage):void {
		...
		if(Scratch.app.allow3D) { if(app.isIn3D) app.render3D.setStage(project, project.penLayer); }
		...
		app.extensionManager.step();
		app.projectLoaded();
		if(Scratch.app.allow3D) { checkForGraphicEffects(); }
	}
