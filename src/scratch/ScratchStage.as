...
public class ScratchStage extends ScratchObj {
	...
	public function step(runtime:ScratchRuntime):void {
		if (videoImage != null) {
			...
			if(Scratch.app.allow3D) { if(Scratch.app.isIn3D) Scratch.app.render3D.updateRender(videoImage); }
		}
...
//	    		testBM.bitmapData = bmd;
	...
	public function clearPenStrokes():void {
		...
		penActivity = false;
		if(Scratch.app.allow3D) { if(Scratch.app.isIn3D) Scratch.app.render3D.updateRender(penLayer); }
	}
