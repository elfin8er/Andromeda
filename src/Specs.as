...
public class Specs {
	...
	public static var commands:Array = [
		...
		["%s contains %s",						"b", 8, ":contains:",		"hello", "world"],
		["-"],
		["%n mod %n",							"r", 8, "%",					"", ""],
		["round %n",							"r", 8, "rounded", 				""],
		["%n a whole number",								"b", 8, ":aWholeNumber",					""],
		["-"],
		...
		// Android blocks
		["can vibrate?",						"r", 13, "canVibrate"],
		["vibrate %n ms",						" ", 13, "vibrate", 		2000],
		["-"],
		["has gyro?",							"r", 13, "canGyro"],
		["gyro X",								"r", 13, "gyroX"],
		["gyro Y",								"r", 13, "gyroY"],
		["gyro Z",								"r", 13, "gyroZ"],
		// Add Gyro X, Y, and Z
		["-"],
		["has GPS?",							"r", 13, "hasGps"],
		["Latitude",							"r", 13, "geoLat"],
		["Longnitude",							"r", 13, "geoLon"],
		["Speed",								"r", 13, "speed"],
		["-"],
		["show message %s with title %s",		" ", 13, "showMessage",		"Message", "Title"],
		["-"],
		//["get contact",							" ", 13, "getContact"],
		//["contact number",						"r", 13, "contactNumber"],
		["send sms message to %s with message %s",	" ", 13, "sendSMS",		"12345554321", "Message"],
